      ...
      <div className="detail-info-section__container">
        ...
        <div className="detail-info-section__content">
          ...
          <p className="detail-info-section__description">
            Kun Khmer ( គុន ខ្មែរ ) или Прадал Серей ( ប្រដាល់សេរី ) - это боевое искусство и спортивное единоборство из
            Камбоджи. «Прадал» означает борьбу или бокс и «Серей» означает свободный или «вольная борьба». Спортивный
            вариант единоборства состоит из ударов в стойке кулаками в боксерских перчатках, локтями, ногами, и
            захватов. Задача бойца Kun Khmer состоит в том, чтобы повергнуть противника - технический нокаут, нокаут или
            выиграть по очкам. Очень похож на современный Муай Тай.
          </p>
          <Button
            type="button"
